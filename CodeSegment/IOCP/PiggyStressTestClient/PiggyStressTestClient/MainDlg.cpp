...
{
    CDialog::DoDataExchange(pDX);
    DDX_Text(pDX, IDC_EDIT_REQ, m_reqNum);
    DDX_Text(pDX, IDC_STATIC_QPS, m_strQPS);
}
...
void CMainDlg::QpsTimerProc()
{
    m_NowQ = m_reqNum;
    m_strQPS.Format(_T("%lld"), m_NowQ-m_LastQ);
    m_LastQ = m_NowQ;
    UpdateData(FALSE);
}
...
void CMainDlg::InitListCtrl()
{
    ...
    pList->InsertColumn(0, _T("INFORMATION"), LVCFMT_LEFT, 500);
}
